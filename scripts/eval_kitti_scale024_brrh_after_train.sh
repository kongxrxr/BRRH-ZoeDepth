...
TRAIN_SESSION="${TRAIN_SESSION:-zoe_kitti_scale024_brrh}"
...
CKPT_DIR="${CKPT_DIR:-/home/kxr/zoedepth_kitti_brrh_scale0p24_256x512_bs4_workers8_checkpoints}"
OUT="${OUT:-${REPO_DIR}/logs/kitti_brrh_scale0p24_bs4_workers8_hard_boundary_metrics.json}"
...
echo "===== HARD BOUNDARY EVAL BRRH scale0.24 checkpoint=${ckpt} $(date '+%F %T %Z') ====="
...
echo "===== BRRH SCALE 0.24 EVAL DONE $(date '+%F %T %Z') ====="
