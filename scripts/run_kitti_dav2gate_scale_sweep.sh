...
BASE_CHECKPOINT="${BASE_CHECKPOINT:-/home/kxr/zoedepth_kitti_beit_dav2gate_256x512_bs1_checkpoints/ZoeDepthv1_04-Jun_23-27-423e5fbaa1df_latest.pt}"
...
for scale in 0.04 0.12; do
  ...
  echo "===== START DA boundary-gate scale ${scale} $(date '+%F %T %Z') ====="
