...
TRAIN_SESSION="${TRAIN_SESSION:-zoe_kitti_scale024_noboundaryloss}"
...
CKPT_DIR="${CKPT_DIR:-/home/kxr/zoedepth_kitti_beit_dav2gate_scale0p24_noboundaryloss_skipnan_256x512_bs4_workers8_checkpoints}"
OUT="${OUT:-${REPO_DIR}/logs/kitti_beit_dav2gate_scale0p24_noboundaryloss_bs4_workers8_hard_boundary_metrics.json}"
...
echo "===== HARD BOUNDARY EVAL scale0.24 no-boundary-loss checkpoint=${ckpt} $(date '+%F %T %Z') ====="
...
echo "===== SCALE 0.24 NO-BOUNDARY-LOSS EVAL DONE $(date '+%F %T %Z') ====="
