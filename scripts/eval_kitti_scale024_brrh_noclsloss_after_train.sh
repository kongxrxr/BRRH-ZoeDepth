...
TRAIN_SESSION="${TRAIN_SESSION:-zoe_kitti_scale024_brrh_noclsloss}"
CKPT_DIR="${CKPT_DIR:-/home/kxr/zoedepth_kitti_brrh_noclsloss_scale0p24_256x512_bs4_workers8_5ep_checkpoints}"
OUT="${OUT:-${REPO_DIR}/logs/kitti_brrh_noclsloss_scale0p24_bs4_workers8_5ep_hard_boundary_metrics.json}"
...
echo "===== HARD BOUNDARY EVAL BRRH no-cls-loss scale0.24 checkpoint=${ckpt} $(date '+%F %T %Z') ====="
...
echo "===== BRRH NO-CLS-LOSS SCALE 0.24 EVAL DONE $(date '+%F %T %Z') ====="
